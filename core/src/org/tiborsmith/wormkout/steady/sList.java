 ...
 */
public class sList<T> extends Widget implements Cullable {
    ...
    public sList(Skin skin) {
        this(skin.get(ListStyle.class));
        shader = null;
        scale = 1;
    }

    public sList(Skin skin, ShaderProgram shader) {
        this(skin.get(ListStyle.class));
        this.shader = shader;
        scale = 1;
    }
    ...
    /*public sList(Skin skin, String styleName) {
        this(skin.get(styleName, ListStyle.class));
    }*/

    public sList(ListStyle style) {
