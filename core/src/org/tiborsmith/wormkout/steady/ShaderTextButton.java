...
public class ShaderTextButton extends Button {
    ...
    public ShaderTextButton (String text, Skin skin) {
        this(text, skin.get(TextButtonStyle.class));
        setSkin(skin);
    }

    public ShaderTextButton (String text, Skin skin, String styleName) {
        this(text, skin.get(styleName, TextButtonStyle.class));
        setSkin(skin);
    }

    public ShaderTextButton (String text, TextButtonStyle style) {
        super();
        setStyle(style);
        this.style = style;
        label = new ShaderLabel(text, new Label.LabelStyle(style.font, style.fontColor));
