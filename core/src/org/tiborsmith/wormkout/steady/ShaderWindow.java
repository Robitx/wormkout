 ...
 */
public class ShaderWindow extends Table {
    ...
    public ShaderWindow(String title, Skin skin) {
    ...
    public ShaderWindow(String title, Skin skin, String styleName) {
        this(title, skin.get(styleName, WindowStyle.class));
        setSkin(skin);
    }

    public ShaderWindow(String title, WindowStyle style) {
    ...
    /** The style for a window, see {@link ShaderWindow}.
     * @author Nathan Sweet */
