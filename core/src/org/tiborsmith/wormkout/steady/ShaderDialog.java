 ...
 */
public class ShaderDialog extends ShaderWindow {
    ...
    public ShaderDialog (String title, Skin skin) {
        super(title, skin.get(WindowStyle.class));
        this.skin = skin;
        initialize();
    }

    public ShaderDialog (String title, Skin skin, String windowStyleName) {
    ...
    public ShaderDialog (String title, WindowStyle windowStyle) {
        ...
        addListener(new FocusListener() {
            ...
            private void focusChanged (FocusEvent event) {
                ...
                if (isModal() && stage != null && stage.getRoot().getChildren().size > 0
                        && stage.getRoot().getChildren().peek() == ShaderDialog.this) { // Dialog is top most actor.
                    Actor newFocusedActor = event.getRelatedActor();
                    if (newFocusedActor != null && !newFocusedActor.isDescendantOf(ShaderDialog.this)) event.cancel();
                }
            }
        });
    }
    ...
    public ShaderDialog text (String text) {
        if (skin == null)
    ...
    public ShaderDialog text (String text, Label.LabelStyle labelStyle) {
        return text(new ShaderLabel(text, labelStyle));
    }

    /** Adds the given Label to the content table */
    public ShaderDialog text (ShaderLabel label) {
    ...
    public ShaderDialog button (String text) {
    ...
    public ShaderDialog button (String text, Object object) {
        if (skin == null)
            throw new IllegalStateException("This method may only be used if the dialog was constructed with a Skin.");
        return button(text, object, skin.get(ShaderTextButton.TextButtonStyle.class));
    }

    /** Adds a text button to the button table.
     * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
    public ShaderDialog button (String text, Object object, ShaderTextButton.TextButtonStyle buttonStyle) {
        return button(new ShaderTextButton(text, buttonStyle), object);
    }

    /** Adds the given button to the button table. */
    public ShaderDialog button (Button button) {
        return button(button, null);
    }

    /** Adds the given button to the button table.
     * @param object The object that will be passed to {@link #result(Object)} if this button is clicked. May be null. */
    public ShaderDialog button (Button button, Object object) {
    ...
    public ShaderDialog show (Stage stage, Action action) {
        clearActions();
    ...
    public ShaderDialog show (Stage stage) {
    ...
    public ShaderDialog key (final int keycode, final Object object) {
